...
export const FMIP_PRODUCTS: readonly FmipProductDefinition[] = [
  {
    ...
    requiredStages: ["capture", "quality", "pose", "motion", "events", "biomechanics", "protocol", "clinical-review", "report"],
  },
  {
    id: "posturevision",
    name: "PostureVision",
    ...
    requiredStages: ["capture", "quality", "pose", "biomechanics", "protocol", "clinical-review", "report"],
  },
  {
    id: "gaitvision",
    name: "GaitVision",
