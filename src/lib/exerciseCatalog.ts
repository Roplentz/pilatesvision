...
const ENRICHED_ITEMS: ExerciseCatalogItem[] = [
  enrich({
    id: "mat_hundred", namePt: "Cem", nameEn: "The Hundred",
    category: "mat", apparatus: "Solo", level: "intermediario",
    equipment: "Mat", methodFamily: "Mat clássico/contemporâneo",
  ...
  enrich({
    id: "mat_roll_up", namePt: "Rolamento para cima", nameEn: "Roll Up",
    category: "mat", apparatus: "Solo", level: "intermediario",
    equipment: "Mat", methodFamily: "Mat clássico/contemporâneo",
    ...
    regression: "half roll back", progression: "roll up completo com controle",
  }),
  enrich({
    id: "mat_pelvic_curl", namePt: "Ponte articulada", nameEn: "Pelvic Curl",
    category: "mat", apparatus: "Solo", level: "basico",
    equipment: "Mat", methodFamily: "Mat contemporâneo/clínico",
    ...
    regression: "ponte baixa", progression: "single leg bridge",
  }),
  enrich({
    id: "mat_single_leg_stretch", namePt: "Alongamento unilateral de perna",
    nameEn: "Single Leg Stretch",
    category: "mat", apparatus: "Solo", level: "intermediario",
    equipment: "Mat", methodFamily: "Mat clássico",
    ...
    regression: "cabeça apoiada", progression: "double leg stretch",
  }),
  enrich({
    id: "mat_double_leg_stretch", namePt: "Alongamento duplo de pernas",
    ...
    regression: "reduzir amplitude", progression: "pernas mais baixas e longas",
  }),
  enrich({
    id: "mat_spine_stretch", namePt: "Alongamento da coluna",
    ...
    regression: "sentar em apoio elevado", progression: "adicionar rotação",
  }),
  enrich({
    id: "mat_swan_prep", namePt: "Preparação para cisne", nameEn: "Swan Prep",
    category: "mat", apparatus: "Solo", level: "basico",
    equipment: "Mat", methodFamily: "Mat contemporâneo/clínico",
  ...
  enrich({
    id: "mat_swimming", namePt: "Natação", nameEn: "Swimming",
    category: "mat", apparatus: "Solo", level: "intermediario",
    equipment: "Mat", methodFamily: "Mat clássico",
    position: "decúbito ventral",
    ...
    regression: "elevar apenas braços ou pernas", progression: "maior tempo/cadência",
  }),
  enrich({
    id: "mat_side_kick", namePt: "Chute lateral", nameEn: "Side Kick Series",
    category: "mat", apparatus: "Solo", level: "intermediario",
    equipment: "Mat", methodFamily: "Mat clássico",
    ...
    regression: "joelho flexionado", progression: "círculos e variações avançadas",
    displayName: "Side Kick (série)",
  }),
  enrich({
    id: "mat_teaser_prep", namePt: "Preparação para teaser", nameEn: "Teaser Prep",
    category: "mat", apparatus: "Solo", level: "avancado",
    equipment: "Mat", methodFamily: "Mat clássico/contemporâneo",
    ...
    regression: "half teaser", progression: "teaser completo",
  }),
  enrich({
    id: "mat_plank", namePt: "Prancha", nameEn: "Plank",
    category: "mat", apparatus: "Solo", level: "intermediario",
    equipment: "Mat", methodFamily: "Mat contemporâneo/clínico",
    ...
    regression: "joelhos apoiados", progression: "leg pull front",
  }),
  enrich({
    id: "mat_cat_stretch", namePt: "Gato", nameEn: "Cat Stretch",
    category: "mat", apparatus: "Solo", level: "basico",
    equipment: "Mat", methodFamily: "Mat clínico/contemporâneo",
    ...
    regression: "menor amplitude", progression: "adicionar rotação torácica",
  }),
  enrich({
    id: "ref_footwork", namePt: "Trabalho de pés no Reformer",
    nameEn: "Reformer Footwork",
    category: "reformer", apparatus: "Reformer", level: "basico",
    equipment: "Reformer", methodFamily: "Reformer",
    ...
    regression: "menor resistência/amplitude", progression: "variações ponta/calcanhar/unilateral",
    displayName: "Footwork (série)",
  }),
  enrich({
    id: "ref_leg_circles", namePt: "Círculos de pernas nas alças", nameEn: "Leg Circles",
    category: "reformer", apparatus: "Reformer", level: "intermediario",
    equipment: "Reformer", methodFamily: "Reformer",
    ...
    regression: "círculos pequenos", progression: "maior amplitude e coordenação",
  }),
  enrich({
    id: "ref_hundred", namePt: "Cem no Reformer", nameEn: "Hundred on Reformer",
    category: "reformer", apparatus: "Reformer", level: "intermediario",
    equipment: "Reformer", methodFamily: "Reformer",
    ...
    regression: "cabeça apoiada", progression: "pernas estendidas",
    displayName: "The Hundred",
  }),
  enrich({
    id: "ref_short_spine", namePt: "Coluna curta", nameEn: "Short Spine Massage",
    category: "reformer", apparatus: "Reformer", level: "intermediario",
    equipment: "Reformer", methodFamily: "Reformer",
    position: "decúbito dorsal com pés nas alças",
    ...
    regression: "frog/leg circles", progression: "variações avançadas",
    displayName: "Short Spine",
  }),
  enrich({
    id: "ref_bridging", namePt: "Ponte no Reformer", nameEn: "Bridging on Reformer",
    category: "reformer", apparatus: "Reformer", level: "intermediario",
    equipment: "Reformer", methodFamily: "Reformer",
    ...
    redFlags: "dor lombar/joelho", regression: "ponte no mat", progression: "ponte unilateral",
  }),
  enrich({
    id: "ref_long_stretch", namePt: "Alongamento longo", nameEn: "Long Stretch",
    category: "reformer", apparatus: "Reformer", level: "avancado",
    equipment: "Reformer", methodFamily: "Reformer",
    ...
    regression: "plank no mat", progression: "up stretch",
  }),
  enrich({
    id: "ref_scooter", namePt: "Patinete", nameEn: "Scooter",
    category: "reformer", apparatus: "Reformer", level: "intermediario",
    equipment: "Reformer", methodFamily: "Reformer",
    ...
    regression: "menor mola/amplitude", progression: "variação sem apoio",
  }),
  enrich({
    id: "ref_side_splits", namePt: "Aberturas laterais", nameEn: "Side Splits",
    category: "reformer", apparatus: "Reformer", level: "avancado",
    equipment: "Reformer", methodFamily: "Reformer",
    ...
    regression: "standing hip abduction com apoio", progression: "variações com braços",
  }),
  enrich({
    id: "cad_roll_down", namePt: "Rolamento com barra", nameEn: "Roll Down Bar",
    category: "cadillac", apparatus: "Cadillac", level: "intermediario",
    equipment: "Cadillac", methodFamily: "Cadillac",
    ...
    regression: "menor amplitude", progression: "roll up no mat",
    displayName: "Roll Down",
  }),
  enrich({
    id: "cad_leg_springs", namePt: "Molas de pernas", nameEn: "Leg Springs",
    category: "cadillac", apparatus: "Cadillac", level: "intermediario",
    equipment: "Cadillac", methodFamily: "Cadillac",
    ...
    regression: "menor amplitude", progression: "círculos maiores e coordenação",
  }),
  enrich({
    id: "cad_arm_springs", namePt: "Molas de braços", nameEn: "Arm Springs",
    category: "cadillac", apparatus: "Cadillac", level: "intermediario",
    equipment: "Cadillac", methodFamily: "Cadillac",
    ...
    regression: "carga leve", progression: "sentado/ajoelhado",
  }),
  enrich({
    id: "cad_push_through", namePt: "Empurrar através da barra", nameEn: "Push Through",
    category: "cadillac", apparatus: "Cadillac", level: "intermediario",
    equipment: "Cadillac", methodFamily: "Cadillac",
    ...
    regression: "variação com menor mola", progression: "variações avançadas",
    displayName: "Push Through Bar",
  }),
  enrich({
    id: "cad_monkey", namePt: "Macaco", nameEn: "Monkey",
    category: "cadillac", apparatus: "Cadillac", level: "avancado",
    equipment: "Cadillac", methodFamily: "Cadillac",
    ...
    regression: "alongamento assistido simples", progression: "monkey completo",
  }),
  enrich({
    id: "chair_footwork", namePt: "Trabalho de pés na Chair", nameEn: "Chair Footwork",
    category: "chair", apparatus: "Chair", level: "intermediario",
    equipment: "Wunda/Stability Chair", methodFamily: "Chair",
    ...
    regression: "menor mola/amplitude", progression: "unilateral",
    displayName: "Footwork",
  }),
  enrich({
    id: "chair_pike", namePt: "Pike na Chair", nameEn: "Pike",
    category: "chair", apparatus: "Chair", level: "avancado",
    equipment: "Wunda/Stability Chair", methodFamily: "Chair",
    ...
    regression: "elephant no Reformer", progression: "pike avançado",
  }),
  enrich({
    id: "chair_mermaid", namePt: "Sereia na Chair", nameEn: "Mermaid on Chair",
    category: "chair", apparatus: "Chair", level: "intermediario",
    equipment: "Wunda/Stability Chair", methodFamily: "Chair",
    ...
    regression: "mermaid no mat", progression: "maior amplitude",
  }),
  enrich({
    id: "chair_step_up", namePt: "Subida na Chair", nameEn: "Step Up",
    category: "chair", apparatus: "Chair", level: "avancado",
    equipment: "Wunda/Stability Chair", methodFamily: "Chair",
    ...
    regression: "apoio manual", progression: "sem apoio/variações",
  }),
  enrich({
    id: "barrel_swan", namePt: "Cisne no Barrel", nameEn: "Swan on Barrel",
    category: "barrel", apparatus: "Barrel", level: "intermediario",
    equipment: "Ladder Barrel/Spine Corrector", methodFamily: "Barrel",
    ...
    redFlags: "dor lombar/cervical",
    regression: "mini swan no mat", progression: "swan completo",
    displayName: "Swan/Backbend",
  }),
  enrich({
    id: "barrel_side_bend", namePt: "Inclinação lateral no Barrel",
    nameEn: "Side Bend on Barrel",
    category: "barrel", apparatus: "Barrel", level: "intermediario",
    equipment: "Ladder Barrel", methodFamily: "Barrel",
    position: "decúbito lateral",
    ...
    regression: "side bend no mat", progression: "amplitude maior",
  }),
  enrich({
    id: "barrel_horseback", namePt: "Cavalo no Barrel", nameEn: "Horseback",
    category: "barrel", apparatus: "Barrel", level: "avancado",
    equipment: "Ladder Barrel/Arc Barrel", methodFamily: "Barrel",
    ...
    regression: "spine stretch", progression: "horseback com carga/variação",
  }),
  enrich({
    id: "access_magic_circle_adduction", namePt: "Adução com círculo",
    nameEn: "Magic Circle Adduction",
    category: "funcional", apparatus: "—", level: "basico",
    equipment: "Magic Circle", methodFamily: "Acessórios",
    ...
    regression: "menor pressão", progression: "combinar com ponte",
    displayName: "Adução com Magic Circle",
  }),
  enrich({
    id: "access_band_row", namePt: "Remada com faixa", nameEn: "Band Row",
    category: "funcional", apparatus: "—", level: "basico",
    equipment: "Faixa elástica", methodFamily: "Acessórios",
    ...
    regression: "faixa leve", progression: "ajoelhado/em pé com desafio",
    displayName: "Remada com faixa",
  }),
  enrich({
    id: "access_ball_bridge", namePt: "Ponte na bola", nameEn: "Bridge on Ball",
    category: "funcional", apparatus: "—", level: "intermediario",
    equipment: "Bola suíça", methodFamily: "Acessórios",
    ...
    regression: "ponte no mat", progression: "curl de isquios na bola",
    displayName: "Ponte na bola",
  }),
  enrich({
    id: "access_foam_roller_dead_bug", namePt: "Dead bug no rolo",
    nameEn: "Foam Roller Dead Bug",
    category: "funcional", apparatus: "—", level: "intermediario",
    equipment: "Foam roller", methodFamily: "Acessórios",
    ...
    regression: "cabeça apoiada no mat", progression: "alavancas longas",
    displayName: "Dead bug no foam roller",
  }),
  enrich({
    id: "clinical_sit_to_stand", namePt: "Senta e levanta inspirado no Pilates",
    nameEn: "Pilates-based Sit to Stand",
    category: "funcional", apparatus: "—", level: "basico",
    equipment: "Cadeira/Mat", methodFamily: "Clínico funcional",
    ...
    regression: "apoio de mãos", progression: "sem mãos/carga",
    displayName: "Sentar e levantar",
  }),
  enrich({
    id: "clinical_wall_roll_down", namePt: "Rolamento na parede",
    nameEn: "Wall Roll Down",
    category: "funcional", apparatus: "—", level: "basico",
    equipment: "Parede", methodFamily: "Clínico contemporâneo",
    ...
    regression: "menor amplitude", progression: "sem parede",
    displayName: "Rolamento na parede",
  }),
  enrich({
    id: "clinical_balance_reach", namePt: "Alcance em equilíbrio",
    nameEn: "Balance Reach",
    category: "funcional", apparatus: "—", level: "intermediario",
    equipment: "Sem equipamento", methodFamily: "Clínico funcional",
    ...
    regression: "apoio bilateral", progression: "unipodal com alcance multidirecional",
    displayName: "Alcance em equilíbrio",
  }),
  enrich({
    id: "clinical_breathing_rib_cage", namePt: "Respiração costal orientada",
    nameEn: "Lateral Breathing",
    category: "funcional", apparatus: "—", level: "basico",
    equipment: "Mat", methodFamily: "Clínico contemporâneo",
    ...
    regression: "posição confortável", progression: "integrar com movimento",
